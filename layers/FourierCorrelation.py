...
"""
Official FourierCorrelation from FEDformer (Time-Series-Library).
...
class FourierBlock(nn.Module):
    def __init__(self, in_channels, out_channels, n_heads, seq_len,
        ...
        self.weights1 = nn.Parameter(
            self.scale * torch.rand(self.n_heads,
...
class FourierCrossAttention(nn.Module):
    def __init__(self, in_channels, out_channels, seq_len_q, seq_len_kv,
        ...
        self.scale = (1 / (in_channels * out_channels))
        self.weights1 = nn.Parameter(
            self.scale * torch.rand(num_heads,
    ...
    def forward(self, q, k, v, mask):
        ...
        xqkvw = self.compl_mul1d("bhex,heox->bhox", xqkv_ft,
