"""
Official MultiWaveletCorrelation from FEDformer (Time-Series-Library).
...
class MultiWaveletCross(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, seq_len_q, seq_len_kv,
                 modes, c=64, k=8, ich=512, L=0, base='legendre',
                 mode_select_method='random', initializer=None,
