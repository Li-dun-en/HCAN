...
# --- pred_len=96 | MSE=TBD | gate_power=0, num_fine=8 ---
python -u run.py \
...
# --- pred_len=192 | MSE=TBD | gate_power=2, num_fine=8 ---
python -u run.py \
  --is_training 1 --model Autoformer --data ETTh2 \
  --root_path ./dataset/ETT-small/ --data_path ETTh2.csv \
...
# --- pred_len=336 | MSE=TBD | gate_power=2, num_fine=8 ---
python -u run.py \
  --is_training 1 --model Autoformer --data ETTh2 \
  --root_path ./dataset/ETT-small/ --data_path ETTh2.csv \
...
# --- pred_len=720 | MSE=TBD | gate_power=4, num_fine=8 ---
python -u run.py \
  --is_training 1 --model Autoformer --data ETTh2 \
  --root_path ./dataset/ETT-small/ --data_path ETTh2.csv \
